...
export default function NewCompanyPage() {
  return (
    <div className="max-w-2xl">
      ...
      <form action={createCompany} className="bg-card-bg rounded-xl border border-border/60 p-6 shadow-sm space-y-5">
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select name="priority" defaultValue="5" className="border border-border rounded-lg w-full px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent">
