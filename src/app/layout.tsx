            ...
            <aside className="w-[220px] bg-sidebar-bg flex flex-col fixed h-full border-r border-white/[0.06]">
              ...
              <nav className="flex-1 px-2.5 overflow-y-auto">
                ...
                <NavSection label="Contacts">
                  ...
                  <NavLink href="/groups" icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg>} label="Groups" />
                </NavSection>
