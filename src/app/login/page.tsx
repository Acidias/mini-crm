    ...
    <div className="min-h-screen flex items-center justify-center bg-[#18181b] relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm px-6">
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-2xl bg-teal-500/20 flex items-center justify-center mx-auto mb-4">
          ...
          <p className="text-zinc-500 text-sm mt-1.5">Contact and company management</p>
        </div>

        <div className="bg-zinc-900/80 backdrop-blur-sm rounded-2xl border border-white/[0.06] p-6">
          <form
            action={async () => {
              "use server";
          ...
          >
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 bg-white text-zinc-900 px-5 py-3 rounded-xl text-sm font-semibold hover:bg-zinc-100 transition-colors"
            >
