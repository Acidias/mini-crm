      ...
      >
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select name="priority" defaultValue={person.priority?.toString() || "5"} className="border border-border rounded-lg w-full px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-accent/20 focus:border-accent">
